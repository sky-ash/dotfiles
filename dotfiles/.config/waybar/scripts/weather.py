...
# slightly adjusted by me (sky-ash)
...
# temperature (C) as integer
tempint = int(weather['current_condition'][0]['FeelsLikeC'])

# add an extra + in front for single-digit positive temperatures 
extrachar = ''
if tempint > 0 and tempint < 10:
    extrachar = '+'

# initialize empty data dir
data = {}

# translate weather codes to emojis
WEATHER_CODES = {
    '113': '',
    '116': '󰖕',
    '119': '',
