...
#config_folders=(btop catnap cava dunst era hypr kitty waybar)
config_folders=(hypr)

# delete config folders in home/.config and create symlinks from the dotfiles/.config to home/.config
